                                        ...
                                        <div class="menu-content d-flex align-items-center px-3">
                                            ...
                                            <div class="d-flex flex-column">
                                                <div class="fw-bold d-flex align-items-center fs-5">
                                                    {{ Auth::user()->name }}
                                                    <span
                                                        class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{ Auth::user()->getRoleNames() }}</span>
                                                </div>
                                                <a href="#"
                                ...
                                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6"
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        <span class="menu-link">
                                            ...
                                            <span class="menu-title">Contas WhatsApp</span>
                                            <span class="menu-arrow"></span>
                                        </span>
                                        <div class="menu-sub menu-sub-accordion">
                                            <div class="menu-item">
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            <div class="menu-item">
                                                <a class="menu-link" href="{{Route('templates.index')}}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Listar</span>
                    ...
                    <div id="kt_app_footer" class="app-footer">
                        <div
                            ...
                            <div class="text-gray-900 order-2 order-md-1">
                                ...
                                <a href="https://shieldsystems.com.br" target="_blank"
                                    class="text-gray-800 text-hover-primary">Shield Systems</a>
                            </div>
                        </div>
                    </div>
                </div>
